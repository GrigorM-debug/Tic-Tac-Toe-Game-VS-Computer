...
namespace Tic_tac_toe
{
    class Program
    {
        ...
        static int MiniMax(char[,] board, char player)
        {
            ...
            // Loop through the board to find available moves
            ...
            {
                int maxScore = -2; // Initialize with a value lower than the lowest possible score
            ...
            {
                int minScore = 2; // Initialize with a value higher than the highest possible score
                for (int i = 0; i < scores.Count; i++)
                {
        ...
        {
            int bestScore = -2; // Initialize with a value lower than the lowest possible score
            int bestRow = -1;
            int bestCol = -1;
